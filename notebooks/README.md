...
`legacy/repn_kfold_original.ipynb` is the original exploratory experiment.
It is preserved for provenance and contains historical absolute Windows paths,
notebook-global variables, and saved outputs.
